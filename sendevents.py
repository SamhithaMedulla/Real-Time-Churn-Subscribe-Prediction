...
if not os.getenv("EVENT_HUB_CONN_STR"):
    raise RuntimeError("❌ Missing EVENT_HUB_CONN_STR — check Railway Variables")
if not os.getenv("EVENT_HUB_NAME"):
    raise RuntimeError("❌ Missing EVENT_HUB_NAME — check Railway Variables")
